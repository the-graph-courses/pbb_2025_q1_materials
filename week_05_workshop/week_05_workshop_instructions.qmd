...
Create a subset containing the following demographic information: employment title, employment length, state, homeownership status. You may need to consult the data dictionary to identify which variables you need. Call your subset `demog_loan_info`.
